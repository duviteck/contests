 ...
 * 2013 year
 */
public class Problem_A_Hull implements Runnable {

    private static BufferedReader reader;
    private static StringTokenizer st;
    private static final String filename = "hull";

    public static void main(String[] args) {
        new Thread(new Problem_A_Hull()).start();
    }
    ...
    private void solve() throws IOException {
        ...
        // TODO: add exception if points less then 3
        ...
        writer.println(hullLen);
        for (int i = 0; i < hullLen; i++) {
            writer.println(hull[i].x + " " + hull[i].y);
        }
    ...
    class PointPolarAngleComparator<MyPoint> implements Comparator<MyPoint> {
        ...
        public int compare(MyPoint o1, MyPoint o2) {
            Problem_A_Hull.MyPoint p1 = (Problem_A_Hull.MyPoint)o1;
            Problem_A_Hull.MyPoint p2 = (Problem_A_Hull.MyPoint)o2;
